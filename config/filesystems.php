...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'projects' => [
            'driver' => 'local',
            'root' => storage_path('app/public/projects/images'),
            'url' => env('APP_URL').'/storage/projects/images',
            'visibility' => 'public',
        ],
        
        'listings' => [
            'driver' => 'local',
            'root' => storage_path('app/public/listings/images'),
            'url' => env('APP_URL').'/storage/listings/images',
            'visibility' => 'public',
        ],

        'users' => [
            'driver' => 'local',
            'root' => storage_path('app/public/users/images'),
