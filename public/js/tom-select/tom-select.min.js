...
!function(e, t) {
    ...
    const r = {
      ...
      , u = e=>{
        void 0 === o && (o = (()=>{
            ...
            return t.sort(((e,t)=>e.length - t.length)).forEach((t=>{
                var i = p(t).map((t=>(t = t.map((t=>e.hasOwnProperty(t) ? d(e[t]) : t)),
                d(t, ""))))
                s[t] = d(i)
            }
            )),
      ...
      , v = (e,t,i)=>{
        var s, n
        return e ? -1 === (n = (e += "").search(t.regex)) ? 0 : (s = t.string.length / e.length,
        0 === n && (s += .5),
        s * i) : 0
    }
      , f = e=>(e + "").replace(/([\$\(-\+\.\?\[-\^\{-\}])/g, "\\$1")
    ...
    class b {
        ...
        tokenize(e, t, i) {
            ...
            const s = []
              , n = e.split(/\s+/)
            var o
            return i && (o = new RegExp("^(" + Object.keys(i).map(f).join("|") + "):(.*)$")),
            n.forEach((e=>{
                let i, n = null, r = null
                o && (i = e.match(o)) && (n = i[1],
                e = i[2]),
    ...
    const q = e=>null == e ? null : D(e)
      ...
      , N = e=>(e + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;")
      , z = (e,t)=>{
        var i
        return function(s, n) {
            var o = this
      ...
      , K = (e,t)=>!!t && (!!t[e] && 1 === (t.altKey ? 1 : 0) + (t.ctrlKey ? 1 : 0) + (t.shiftKey ? 1 : 0) + (t.metaKey ? 1 : 0))
      , M = (e,t)=>{
    ...
    function U(e, t) {
        ...
        y(e.children, (e=>{
            var t, i, s
            "optgroup" === (u = e.tagName.toLowerCase()) ? ((s = f(t = e))[a] = s[a] || t.getAttribute("label") || "",
            s[c] = s[c] || v++,
            s[r] = s[r] || t.disabled,
            O.optgroups.push(s),
            i = s[c],
    ...
    class W extends (function(e) {
        ...
        constructor(e, t) {
            ...
            this.inputId = M(s, "tomselect-" + J),
            this.isRequired = s.required,
            this.sifter = new b(this.options,{
                diacritics: t.diacritics
            }),
            t.mode = t.mode || (1 === t.maxItems ? "single" : "multi"),
            "boolean" != typeof t.hideSelected && (t.hideSelected = "multi" === t.mode),
            "boolean" != typeof t.hidePlaceholder && (t.hidePlaceholder = "multi" !== t.mode)
            var n = t.createFilter
            "function" != typeof n && ("string" == typeof n && (n = new RegExp(n)),
            n instanceof RegExp ? t.createFilter = e=>n.test(e) : t.createFilter = ()=>!0),
            ...
            const o = w("<div>")
              ...
              , a = w('<div role="listbox" tabindex="-1">')
              , c = this.input.getAttribute("class") || ""
              , d = t.mode
            var p
            if (C(o, t.wrapperClass, c, d),
            C(r, t.controlClass),
            G(o, r),
            C(l, t.dropdownClass, d),
            t.copyClassesToDropdown && C(l, c),
            C(a, t.dropdownContentClass),
            G(l, a),
            w(t.dropdownParent || o).appendChild(l),
            t.hasOwnProperty("controlInput"))
                t.controlInput ? (p = w(t.controlInput),
                this.focus_node = p) : (p = w("<input/>"),
                this.focus_node = r)
            else {
                p = w('<input type="text" autocomplete="off" size="1" />')
                y(["autocorrect", "autocapitalize", "autocomplete"], (e=>{
                    s.getAttribute(e) && E(p, {
                        [e]: s.getAttribute(e)
                    })
                }
                )),
        ...
        setup() {
            ...
            (null === t.maxItems || t.maxItems > 1) && e.is_select_tag && E(l, {
                multiple: "multiple"
            }),
            e.settings.placeholder && E(i, {
                placeholder: t.placeholder
            }),
            !e.settings.splitOn && e.settings.delimiter && (e.settings.splitOn = new RegExp("\\s*" + f(e.settings.delimiter) + "+\\s*")),
            ...
            B(r, "click", (t=>{
                ...
                s && e.onItemSelect(t, s) ? H(t, !0) : "" == i.value && (e.onClick(),
                H(t, !0))
            }
            )),
            B(i, "mousedown", (e=>{
        ...
        onKeyDown(e) {
            ...
            if (t.isLocked)
                ...
                case 38:
                    ...
                    return void H(e)
                case 13:
                    return void (t.isOpen && t.activeOption ? (t.onOptionSelect(e, t.activeOption),
                    H(e)) : t.settings.create && t.createItem() && H(e))
                case 37:
                    return void t.advanceSelection(-1, e)
                case 39:
                    return void t.advanceSelection(1, e)
                case 9:
                    return void (t.settings.selectOnTab && (t.isOpen && t.activeOption && (t.onOptionSelect(e, t.activeOption),
                    H(e)),
        ...
        onOptionSelect(e, t) {
            var i, s = this
            t && (t.parentElement && t.parentElement.matches("[data-disabled]") || (t.classList.contains("create") ? s.createItem(null, !0, (()=>{
        ...
        onItemSelect(e, t) {
            var i = this
            return !i.isLocked && "multi" === i.settings.mode && (H(e),
            i.setActiveItem(t, e),
            !0)
        }
        canLoad(e) {
        ...
        load(e) {
            ...
            if (!t.canLoad(e))
                return
            C(t.wrapper, t.settings.loadingClass),
            t.loading++
        ...
        setActiveItem(e, t) {
            ...
            if ("single" !== a.settings.mode) {
                ...
                if ("click" === (i = t && t.type.toLowerCase()) && K("shiftKey", t) && a.activeItems.length) {
                    ...
                    "click" === i && K(V, t) || "keydown" === i && K("shiftKey", t) ? e.classList.contains("active") ? a.removeActiveItem(e) : a.setActiveItemClass(e) : (a.clearActiveItems(),
        ...
        clearActiveOption() {
            this.activeOption && (S(this.activeOption, "active"),
            E(this.activeOption, {
                "aria-selected": null
            })),
            this.activeOption = null,
        ...
        selectAll() {
            "single" !== this.settings.mode && (this.activeItems = this.controlChildren(),
            this.activeItems.length && (C(this.activeItems, "active"),
            this.hideInput(),
            this.close()),
            this.focus())
        }
        inputState() {
            var e = this
            e.control.contains(e.control_input) && (e.activeItems.length > 0 || !e.isFocused && this.settings.hidePlaceholder && e.items.length > 0 ? (e.setTextboxValue(),
            e.isInputHidden = !0,
            C(e.wrapper, "input-hidden")) : (e.isInputHidden = !1,
            S(e.wrapper, "input-hidden")))
        }
        hideInput() {
            this.inputState()
        }
        ...
        search(e) {
            ...
            if (n.settings.score && "function" != typeof (s = n.settings.score.call(n, e)))
                throw new Error('Tom Select "score" setting must be a function that returns a function')
            if (e !== n.lastQuery ? (n.lastQuery = e,
            i = n.sifter.search(e, Object.assign(o, {
                score: s
            })),
            n.currentResults = i) : i = Object.assign({}, n.currentResults),
        ...
        refreshOptions(e=!0) {
            ...
            for (O && (c = O.dataset.value,
            d = O.closest("[data-group]")),
            n = m.items.length,
            "number" == typeof v.settings.maxOptions && (n = Math.min(n, v.settings.maxOptions)),
            n > 0 && (b = !0),
            t = 0; t < n; t++) {
                let e = m.items[t].id
                  , n = v.options[e]
                  , l = v.getOption(e, !0)
                for (v.settings.hideSelected || l.classList.toggle("selected", v.items.includes(e)),
                o = n[v.settings.optgroupField] || "",
                i = 0,
                s = (r = Array.isArray(o) ? o : [o]) && r.length; i < s; i++)
                    o = r[i],
                    v.optgroups.hasOwnProperty(o) || (o = ""),
                    u.hasOwnProperty(o) || (u[o] = document.createDocumentFragment(),
                    h.push(o)),
                    i > 0 && (l = l.cloneNode(!0),
                    E(l, {
                        id: n.$id + "-clone-" + i,
            ...
            this.settings.lockOptgroupOrder && h.sort(((e,t)=>(v.optgroups[e] && v.optgroups[e].$order || 0) - (v.optgroups[t] && v.optgroups[t].$order || 0))),
            ...
            w.innerHTML = "",
            G(w, l),
            v.settings.highlight && (g = w.querySelectorAll("span.highlight"),
            ...
            if (v.loading ? _("loading") : v.settings.shouldLoad.call(v, f) ? 0 === m.items.length && _("no_results") : _("not_loading"),
            (a = v.canCreate(f)) && (p = _("option_create")),
            v.hasOptions = m.items.length > 0 || a,
            b) {
                if (m.items.length > 0) {
                    if (!w.contains(O) && "single" === v.settings.mode && v.items.length && (O = v.getOption(v.items[0])),
                    !w.contains(O)) {
                        let e = 0
                    ...
                    p && (O = p)
                e && !v.isOpen && (v.open(),
                v.scrollToOption(O, "auto")),
                v.setActiveOption(O)
            } else
                v.clearActiveOption(),
                e && v.isOpen && v.close(!1)
        }
        selectable() {
        ...
        updateOption(e, t) {
            ...
            const l = i.getOption(o)
              , a = i.getItem(o)
            if (t.$order = t.$order || i.options[o].$order,
            delete i.options[o],
            i.uncacheValue(r),
            i.options[r] = t,
            l) {
                if (i.dropdown_content.contains(l)) {
                    ...
                    P(l, e),
                    i.activeOption === l && i.setActiveOption(e)
                }
                l.remove()
            }
            a && (-1 !== (n = i.items.indexOf(o)) && i.items.splice(n, 1, r),
            s = i._render("item", t),
        ...
        addItems(e, t) {
            ...
            for (let e = 0, n = (s = s.filter((e=>-1 === i.items.indexOf(e)))).length; e < n; e++)
                i.isPending = e < n - 1,
                i.addItem(s[e], t)
        }
        addItem(e, t) {
        ...
        refreshValidityState() {
            var e = this
            e.input.checkValidity && (e.isValid = e.input.checkValidity(),
        ...
        updateOriginalInput(e={}) {
            ...
            if (t.is_select_tag) {
                const e = []
                function o(i, s, o) {
                    return i || (i = w('<option value="' + N(s) + '">' + N(o) + "</option>")),
                ...
                0 == t.items.length && "single" == t.settings.mode ? o(n, "", "") : t.items.forEach((n=>{
                    ...
                    e.includes(i.$option)) {
                        o(t.input.querySelector(`option[value="${Q(n)}"]:not(:checked)`), n, s)
                    } else
                        i.$option = o(i.$option, n, s)
                }
                ))
            } else
        ...
        deleteSelection(e) {
            ...
            if (!a.length || "function" == typeof r.settings.onDelete && !1 === r.settings.onDelete.call(r, a, e))
                return !1
            for (H(e, !0),
        ...
        advanceSelection(e, t) {
            var i, s, n = this
            n.rtl && (e *= -1),
            n.inputValue().length || (K(V, t) || K("shiftKey", t) ? (s = (i = n.getLastActive(e)) ? i.classList.contains("active") ? n.getAdjacent(i, e, "item") : i : e > 0 ? n.control_input.nextElementSibling : n.control_input.previousElementSibling) && (s.classList.contains("active") && n.removeActiveItem(i),
        ...
        _render(e, t) {
            var i, s, n = ""
            const o = this
            return "option" !== e && "item" != e || (n = D(t[o.settings.valueField])),
            null == (s = o.settings.render[e].call(this, t, N)) || (s = w(s),
            "option" === e || "option_create" === e ? t[o.settings.disabledField] ? E(s, {
                "aria-disabled": "true"
            }) : E(s, {
                "data-selectable": ""
            }) : "optgroup" === e && (i = t.group[o.settings.optgroupValueField],
            E(s, {
                "data-group": i
            }),
            t.group[o.settings.disabledField] && E(s, {
                "data-disabled": ""
            })),
            "option" !== e && "item" !== e || (E(s, {
                "data-value": n
            }),
            "item" === e ? (C(s, o.settings.itemClass),
            E(s, {
                "data-ts-item": ""
    ...
    return W.define("change_listener", (function() {
        B(this.input, "change", (()=>{
            this.sync()
        }
        ))
    ...
    W.define("checkbox_options", (function() {
        var e = this
          , t = e.onOptionSelect
    ...
    W.define("caret_position", (function() {
        var e = this
    ...
    W.define("dropdown_input", (function() {
        var e = this
        e.settings.shouldOpen = !0,
        e.hook("before", "setup", (()=>{
            e.focus_node = e.control,
            C(e.control_input, "dropdown-input")
    ...
    W.define("input_autogrow", (function() {
        var e = this
        e.on("initialize", (()=>{
            ...
            for (const e of ["letterSpacing", "fontSize", "fontFamily", "fontWeight", "textTransform"])
                t.style[e] = i.style[e]
            var s = ()=>{
                e.items.length > 0 ? (t.textContent = i.value,
                i.style.width = t.clientWidth + "px") : i.style.width = ""
            }
            s(),
    ...
    W.define("no_backspace_delete", (function() {
        var e = this
          , t = e.deleteSelection
        this.hook("instead", "deleteSelection", (i=>!!e.activeItems.length && t.call(e, i)))
    }
    )),
    W.define("no_active_items", (function() {
    ...
    W.define("optgroup_columns", (function() {
        var e = this
          , t = e.onKeyDown
    ...
    W.define("virtual_scroll", (function() {
        const e = this
          , t = e.canLoad
        ...
        function l(t) {
            return !("number" == typeof e.settings.maxOptions && n.children.length >= e.settings.maxOptions) && !(!(t in o) || !o[t])
        }
        ...
        e.hook("after", "refreshOptions", (()=>{
            const t = e.lastValue
            var i
            l(t) ? (i = e.render("loading_more", {
                query: t
            })) && i.setAttribute("data-selectable", "") : t in o && !n.querySelector(".no-results") && (i = e.render("no_more_results", {
                query: t
            })),
            i && (C(i, e.settings.optionClass),
            n.append(i))
        }
        )),
        e.on("initialize", (()=>{
            ...
            n.addEventListener("scroll", (function() {
                n.clientHeight / (n.scrollHeight - n.scrollTop) < .95 || l(e.lastValue) && (r || (r = !0,
