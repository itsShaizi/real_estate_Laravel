        ...
        <div @click.away="open = false" class="flex flex-col w-full md:w-64 text-white bg-gradient-to-r from-realty-dark to-realty-light flex-shrink-0" x-data="{ open: false }">
            ...
            <nav :class="{'block': open, 'hidden': !open}" class="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto">
                ...
                <div @click.away="open = false" class="relative" x-data="{ open: false }">
                    ...
                    <div x-show.transition="open" class="right-0 w-full mt-2 origin-top-right rounded-md shadow-inner">
                        <div class="px-2 py-2 bg-blue-300 rounded-md shadow-inner">
                            ...
                            <a class="block px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-0 hover:text-white focus:text-white hover:bg-realty transform hover:translate-x-1 transition-transform ease-in duration-200" href="/agent-room/calendar">Calendar</a>
                        </div>
                    </div>
                </div>
                ...
                <div @click.away="open = false" class="relative" x-data="{ open: false }">
                    ...
                    <div x-show.transition="open" class="right-0 w-full mt-2 origin-top-right rounded-md shadow-inner">
                        <div class="px-2 py-2 bg-blue-300 rounded-md shadow-inner">
                            <a class="block px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-0 hover:text-white focus:text-white hover:bg-realty transform hover:translate-x-1 transition-transform ease-in duration-200" href="{{ route('bk-blogs') }}">Posts</a>
                ...
                <a class="block px-4 py-2 mt-2 text-sm text-white bg-transparent rounded-lg hover:text-white focus:text-white hover:bg-realty-dark focus:bg-realty-dark focus:outline-none focus:shadow-outline transform hover:translate-x-1 transition-transform ease-in duration-200" href="{{ route('bk-form-submissions') }}"><span class="fas fa-inbox mr-2"></span> Form Submissions</a>

                <a class="block px-4 py-2 mt-2 text-sm text-white bg-realty-dark rounded-lg hover:text-white focus:text-white hover:bg-realty-dark focus:bg-realty-dark focus:outline-none focus:shadow-outline transform hover:translate-x-1 transition-transform ease-in duration-200" href="{{ route('bk-templates') }}"><span class="fas fa-border-all mr-2"></span> Templates</a>
