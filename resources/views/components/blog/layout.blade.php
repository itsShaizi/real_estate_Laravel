...
<div class="absolute right-1/4 top-0 bg-white bg-opacity-25 text-white flex space-x-2">
    ...
    @include('layouts.navigation', ['class' => 'bg-blue-500 bg-opacity-75 '.($class ?? 'header-background')])
    {{ $slot }}
