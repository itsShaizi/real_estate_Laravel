            ...
            <div class="md:flex mx-auto">
                ...
                <div x-data="{ currentTab : 'How it works'}">
                    <div class="container md:flex mx-auto">
                        <button @click="currentTab = 'How it works'" class="flex rounded-full text-center font-bold border-2 border-gray-300 m-6 p-2 md:w-2/5 hover:text-blue-400 mx-auto">How it works</button>
                            <span class="flex justify-center text-lg text-blue-400 md:ml-3 mx-auto md:transform md:-rotate-90">
                                <i class="fas fa-caret-down fa-3x"></i>
                            </span>
                        <button @click="currentTab = 'Pre-auction offer'" class="flex rounded-full text-center font-bold border-2 border-gray-300 md:w-2/5 md:-ml-4 m-6 p-2 hover:text-blue-400 mx-auto">Pre-auction offer</button>                     
                            <span class="flex justify-center text-lg text-blue-400 lg:ml-3 md:transform md:-rotate-90">
                                <i class="fas fa-caret-down fa-3x"></i>
                            </span>
                        <button @click="currentTab = 'Place a bid'" class="flex rounded-full text-center font-bold border-2 border-gray-300 md:w-2/5 md:-ml-4 m-6 p-2 hover:text-blue-400 mx-auto">Place a bid</button>
                            <span class="flex justify-center text-lg text-blue-400 md:ml-3 md:transform md:-rotate-90">
                                <i class="fas fa-caret-down fa-3x"></i>
                            </span>
                        <button @click="currentTab = 'Change my bid'" class="flex rounded-full text-center font-bold border-2 border-gray-300 md:w-2/5 md:-ml-4 m-6 p-2 hover:text-blue-400 mx-auto">Change my bid</button>                     
                            <span class="flex justify-center text-lg text-blue-400 md:ml-3 md:transform md:-rotate-90">
                                <i class="fas fa-caret-down fa-3x"></i>
                            </span>
                        <button @click="currentTab = 'Back-up bid'" class="flex rounded-full text-center font-bold border-2 border-gray-300 md:w-2/5 md:-ml-4 m-6 p-2 inline-block hover:text-blue-400 active:text-blue-400 mx-auto">Back-up bid</button>
                    </div>
